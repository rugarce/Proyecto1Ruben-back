...
public class ProductoController {
     ...
     */
	@GetMapping("/all")
	public MessageResponseDto<List<ProductoEntity>> allProductos(){
		try {
     ...
     */
	@PostMapping("/create")
	public ProductoEntity createPerson(@RequestBody ProductoDto producto) {
	...
	public MessageResponseDto<ProductoEntity> updatePerson(@PathVariable Long id ,@RequestBody ProductoDto producto) {
		try {
     ...
     *  */
	@GetMapping("/{id}")
	public MessageResponseDto<ProductoEntity> findbyId(@PathVariable Long id) {
		try {
